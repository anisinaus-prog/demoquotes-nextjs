      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-24 lg:grid-cols-2 lg:px-8 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-5 inline-flex w-fit items-center rounded-full border border-orange-500/20 bg-orange-500/10 px-4 py-2 text-sm font-semibold text-orange-300">
              Licensed House Demolition Specialists
            </div>

            <h1 className="max-w-2xl text-5xl font-extrabold leading-tight md:text-6xl">
              Safe & Fast{' '}
              <span className="text-orange-400">House Demolition</span>
              <br />
              Services in Sydney
            </h1>

            <p className="mt-7 max-w-xl text-lg leading-8 text-slate-300">
              Complete residential house demolition, site clearing,
              asbestos-safe removal, and preparation for rebuild projects.
            </p>
            ...
            <div className="mt-14 grid grid-cols-2 gap-5 md:grid-cols-4">
              {[
                ['1000+', 'Houses Demolished'],
                ['15+', 'Years Experience'],
                ['24h', 'Fast Quote Turnaround'],
          ...
          >
            <h2 className="text-3xl font-extrabold">
              Request House Demolition Quote
            </h2>
            ...
            <p className="mt-3 text-slate-600">
              Get a fast, obligation-free quote for your residential demolition
              project.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              >
                ...
                <option value="Single Storey House">Single Storey House</option>
                <option value="Double Storey House">Double Storey House</option>
              ...
              <textarea
                ...
                value={form.message}
                onChange={handleChange}
                placeholder="Project Details (access, size, asbestos concerns, etc.)"
                className="w-full rounded-2xl border border-slate-300 px-5 py-4 outline-none transition focus:border-orange-500 focus:ring-4 focus:ring-orange-100"
              />
              ...
              >
                {loading ? 'Submitting...' : 'Get My House Demolition Quote'}
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-6 text-5xl font-extrabold text-slate-900">
              Complete House Demolition Solutions
            </h2>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              From small homes to large residential structures, we handle every
              stage of demolition safely.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Complete demolition of residential homes with safe debris removal.',
              },
              {
                icon: '🧱',
                title: 'Partial Demolition',
                desc: 'Selective demolition for renovations or extensions.',
              },
              {
                icon: '☣️',
                title: 'Asbestos Safe Removal',
                desc: 'Licensed asbestos handling and safe disposal before demolition.',
              },
              {
                icon: '🚛',
                title: 'Site Clearing',
                desc: 'Full cleanup and removal of all demolition waste and debris.',
              },
              {
                icon: '🏗️',
                title: 'Rebuild Preparation',
                desc: 'Site preparation ready for new construction projects.',
              },
              {
                icon: '📄',
                title: 'Council Compliance',
                desc: 'We help manage permits and compliance requirements.',
              },
            ].map((s, i) => (
              <div
                key={i}
      ...
      <section className="bg-slate-100 py-24">
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-6 text-5xl font-extrabold text-slate-900">
              Trusted House Demolition Experts
            </h2>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              We specialise in residential demolition with a strong focus on
          ...
          <div className="grid gap-6">
            {[
              'Safe residential demolition practices',
              'Licensed & insured demolition contractors',
              'Fast project turnaround times',
              'Eco-friendly waste disposal',
              'Affordable fixed-price quotes',
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-500 py-24 text-white">
        <div className="mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-5xl font-extrabold leading-tight">
            Ready to Demolish Your House Safely?
          </h2>

          <p className="mt-6 text-xl text-orange-50">
            Get a free, no-obligation house demolition quote today.
          </p>

          <div className="mt-10">
            <a
              href="#quote"
              className="inline-flex rounded-2xl bg-slate-950 px-8 py-5 text-lg font-bold text-white hover:bg-slate-900"
            >
              Get Free Quote
            </a>
          </div>
