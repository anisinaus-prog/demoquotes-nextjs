        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-24 lg:grid-cols-2 lg:px-8 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-5 inline-flex w-fit rounded-full border border-orange-500/20 bg-orange-500/10 px-5 py-2 text-sm font-semibold text-orange-300">
              Licensed Concrete Removal Contractors Sydney
            </div>

            <h1 className="max-w-3xl text-5xl font-extrabold leading-tight md:text-6xl">
              Safe & Certified{' '}
              <span className="text-orange-400">Concrete Removal</span>
              <br />
              Services
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-300">
              Professional concrete removal, inspection, testing, and disposal
          ...
          >
            <h2 className="text-3xl font-extrabold">
              Request Concrete Removal Quote
            </h2>

            <p className="mt-3 text-slate-600">
              Submit your concrete removal project details and our licensed team will
              contact you shortly.
            </p>
...
<option value="Concrete Slab Removal">
  Concrete Slab Removal
</option>

<option value="Driveway Removal">
  Driveway Removal
</option>

<option value="Concrete Cutting">
  Concrete Cutting
</option>

<option value="Concrete Breaking">
  Concrete Breaking
</option>

<option value="Commercial Concrete Removal">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-6 text-5xl font-extrabold text-slate-900">
              Complete Concrete Removal Solutions
            </h2>

            <p className="mt-6 text-lg leading-8 text-slate-600">
              We provide concrete cutting, removal and disposal services.
            </p>
          </div>
            ...
            {[
  {
    ...
    desc: 'Professional removal of old concrete slabs from homes, garages, patios, and other areas.',
  },
  {
    icon: '🏠',
    title: 'Residential Concrete Removal',
    desc: 'Safe and efficient concrete removal for driveways, paths, patios, slabs, and residential properties.',
  },
  {
    icon: '🏢',
    title: 'Commercial Concrete Removal',
    desc: 'Concrete removal services for commercial properties, construction sites, shops, and industrial areas.',
  },
  {
    icon: '🚧',
    title: 'Driveway Removal',
    desc: 'Removal of old or damaged concrete driveways to prepare the area for a new driveway or construction.',
  },
  {
    icon: '⚒️',
    title: 'Concrete Breaking',
    desc: 'Professional concrete breaking using suitable equipment for large, thick, or reinforced concrete.',
  },
  {
    icon: '🚛',
    title: 'Concrete Waste Removal',
    desc: 'Removal and responsible disposal or recycling of broken concrete and construction waste.',
  },
].map((service, i) => (
              <div
                key={i}
      ...
      <section className="bg-slate-100 py-24">
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <h2 className="mt-6 text-5xl font-extrabold text-slate-900"> 
              Trusted Concrete Removal Specialists </h2> 
            <p className="mt-6 text-lg leading-8 text-slate-600"> 
              We provide safe, efficient and professional concrete removal services for residential, commercial and construction projects. </p>
          </div>

          <div className="grid gap-6">
            {[ 'Experienced and insured concrete removal contractors', 'Safe and efficient concrete breaking and removal', 'Residential and commercial concrete expertise', 'Driveway, slab, path and patio removal', 'Suitable equipment for small and large projects', 'Fast response and competitive pricing', ].map((item, i) => (
              <div
                key={i}
  ...
  {[
    {
      ...
      desc: 'We inspect the concrete, assess site access and conditions, and plan the safest and most efficient removal method.',
    },
    {
      number: '02',
      title: 'Concrete Breaking & Removal',
      desc: 'Concrete is safely broken up and removed using suitable equipment, including excavators, jackhammers and other machinery.',
    },
    {
      number: '03',
      title: 'Clean-Up & Disposal',
      desc: 'The broken concrete is removed from site and taken to an appropriate recycling or disposal facility, leaving the area clean and ready for the next stage.',
    },
  ].map((step, i) => (
              <div
                key={i}
      ...
      <section className="bg-gradient-to-r from-orange-600 to-orange-500 py-24 text-white">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mt-6 text-xl text-orange-50">
            Contact our concrete removal specialists today for safe and compliant
            removal services.
          </p>
